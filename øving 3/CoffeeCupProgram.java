...
public class CoffeeCupProgram {
	...
	private void part1(){
		...
		cup.drinkCoffee(40); // you cant drink this much coffee! current is 5
		cup.drinkCoffee(Math.ceil(r.nextDouble()*42));
		cup.drinkCoffee(Math.floor(r.nextDouble()*20.5));
		cup.fillCoffee(32.5);
		cup.drinkCoffee(Math.ceil(r.nextDouble()*38.9));
	...
	private void part2(){
		...
		cup.fillCoffee(Math.ceil(r.nextDouble()*59)); // IllegalArgumentException prøver å fylle 40 i en kopp med 6,5 som har max 40
		cup.drinkCoffee(Math.ceil(r.nextDouble()*42));
